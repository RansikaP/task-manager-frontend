...
function Home() {
  ...
  const UpcomingTasks = [
    ...
    {
      name:"BoogersBoogersBoogersBoogersBoogersBoogersBoogersBoogers BoogersBoogersBoogersBoogers",
      Project: "Boogers",
      date: "Boogers"
    },
    {
...
<div className = "cards">
  {
    ImportantTasks.map((task,i)=>(
      ...
      <h2 className="label2-color">
        Tasks Due This Week
      </h2>
      <div className = "cards">
  {
    UpcomingTasks.map((task,i)=>(
      <div key={i} className="cardUpcoming">
        <h3>
          Task: {task.name}
        </h3>
        <h4>
      ...
      <div className="formscontainer">
        ...
        <div className="form-box">
          <form onSubmit={handleJoinSubmit}>
            ...
            <label>
              Project Name:
              <input type="text" value={projectName} onChange={handleName} />
            </label>
            <input type="submit" value="Submit" />
          </form>
        </div>
